...
!function(t, e) {
    ...
    return function(t) {
        ...
        function r(t, e) {
            ...
            return f ? (a("ignoring socket cache for %s", i),
                n = s(i, e)) : (c[u] || (a("new io instance for %s", i),
                c[u] = s(i, e)),
                n = c[u]),
        ...
        , function(t, e, n) {
            ...
            function o(t) {
                ...
                function i() {
                    ...
                    return t !== -1 && (o.instances.splice(t, 1),
                        !0)
                }
                function s(t, e) {
                ...
                e.removeBlobs = function(t, e) {
                    function n(t, a, p) {
                        ...
                        if (c && t instanceof Blob || u && t instanceof File) {
                            ...
                            h.onload = function() {
                                p ? p[a] = this.result : o = this.result,
                                --r || e(o)
                            }
                                ,
        ...
        , function(t, e, n) {
            ...
            t.exports = r,
                ...
                r.prototype.probe = function(t) {
                    ...
                    function c(t) {
                        p && t.name !== p.name && (a('"%s" works - aborting "%s"', t.name, p.name),
                            n())
                    }
                    function u() {
